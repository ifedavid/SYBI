...
export default function Home() {
  ...
  const calculateBrandScore = () => {
    ...
    const brandReviews = reviews.filter(
      (review) => review.brand_name === currentBrand.name,
    );
    const totalScore = brandReviews.reduce(
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row justify-center gap-4 mb-8 mt-8">
        <div className="w-full sm:w-[400px] lg:w-[500px]">
          <Select
            value={brandOptions.find((option) => option.value === currentBrand)}
            ...
            <div className="flex items-center gap-4">
              {currentBrand.url && (
                ...
                >
                  ...
                  <span className="sm:inline">Web</span>
                </a>
              )}
              ...
              {currentBrand.insta_url && (
                ...
                >
                  ...
                  <span className="sm:inline">Insta</span>
                </a>
              )}
